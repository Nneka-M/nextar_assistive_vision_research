...
from tts import load_afro_tts, speak, save_wav, eleven_labs_fallback, speak_fallback, facebook_fallback
...
# REFERENCE_WAV=os.path.join(BASE_DIR, "..", "models", "afro-tts", "audios", "reference_accent3.wav")
...
def run_pipiline(image):
    ...
    audio_path = facebook_fallback(scene_description)
